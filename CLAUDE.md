...
Produção: **https://caiobarreto.com.br** (domínio próprio no registro.br, anuidade R$ 40; nameservers ns1/ns2.vercel-dns.com; www também ativo). `og:image`, `og:url` e `canonical` apontam para esse domínio em URL absoluta. O endereço https://portfolio-xi-eight-byzzeubxff.vercel.app segue servindo o mesmo conteúdo. Repo: https://github.com/Caiobadv/portfolio (push manual; Vercel ainda não conectada ao GitHub). O domínio próprio comprova as 15h de atividades complementares (CESAR School).
